...
with mlflow.start_run(run_name=args.commit) as run:
    ...
    # Evaluate on test set - get numeric and string predictions
    ...
    test_accuracy = accuracy_score(y_test, y_pred_numeric)
    print("\nTest Set Classification Report:")
    print(classification_report(y_test_str, y_pred, target_names=class_names))
    ...
    # Log confusion matrix using string labels
